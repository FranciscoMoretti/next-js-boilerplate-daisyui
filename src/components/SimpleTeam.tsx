...
export interface SimpleTeamProps {
...
const SimpleTeam = (props: SimpleTeamProps) => {
  return (
    <div className="p-4">
      ...
      <div className="text-center">
        ...
        <p className="text-xl font-light">{props.job}</p>
        <p className="text-md max-w-xs py-4 font-light">{props.desc}</p>
      </div>
      {props.social && (
